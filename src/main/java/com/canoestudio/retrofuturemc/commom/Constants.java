package com.canoestudio.retrofuturemc.commom;
...
public class Constants {
    ...
    public static final String PATH = "com.canoestudio.";
    ...
    { return (new EntityDamageSource(Tags.MOD_ID + "." + "mace", source)); }

    public static String name(String name) {
        return Tags.MOD_ID + "." + name.toLowerCase(Locale.US);
    }
